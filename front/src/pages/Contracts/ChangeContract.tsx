import { IContract, useGetContract } from '@/hooks/useContracts.ts'
import { useState } from 'react'
import { useNavigate } from 'react-router-dom'
import { put } from '@/utils/http'

export const ChangeContract = (): JSX.Element => {
  const contract = useGetContract(1) as IContract
    ...
    <>
      <div className="grid justify-center">
        <div className="justify-center">
          <h1 className="align-middle text-orange-500 text-3xl font-bold text-center pb-5">Mudança de plano</h1>
